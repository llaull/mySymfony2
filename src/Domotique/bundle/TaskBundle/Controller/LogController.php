...
use Domotique\bundle\TaskBundle\Form\LogType;
...
class LogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DomotiquebundleTaskBundle:Log')->findAll();

        return $this->render('DomotiquebundleTaskBundle:Log:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_taskLog_show', array('id' => $entity->getId())));
        }

        return $this->render('DomotiquebundleTaskBundle:Log:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Log $entity)
    {
        $form = $this->createForm(new LogType(), $entity, array(
            'action' => $this->generateUrl('admin_taskLog_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('DomotiquebundleTaskBundle:Log:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DomotiquebundleTaskBundle:Log:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new LogType(), $entity, array(
            'action' => $this->generateUrl('admin_taskLog_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_taskLog_edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_taskLog_delete', array('id' => $id)))
            ->setMethod('DELETE')
